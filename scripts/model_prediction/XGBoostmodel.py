...
def main():
    """
    Parses training data as features for the XGBoost model. Set model parameters
    optimize the results and produces accuracy and feature importance results at the
    end.
