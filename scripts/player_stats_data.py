...
def get_player_week_data(player_name, team_name, team_data, all_stats, week): 
    week_only_data = team_data[team_data['week'] == week]
    ...
    print(f"Fantasy points for week {week} {total_F_Points_WN}")

    pdp = team_data[team_data['week'] < week]
    ...
    print(f"The total average is {average_F_Points} points, over the past 3 weeks the average is {three_week_average} points")
    percentages = get_week_percentage(team_name, player_name, all_stats, week)
