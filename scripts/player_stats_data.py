...
def get_player_data(player_name, team_name, pdp, all_stats): 
    ...
    player_stats.append({
        ...
        'total_passing_yards': total_P_Yards,
        'total_rushing_yards': total_R_Yards,
        'total_recieving_yards': receiving_yards,
        ...
        'rushing_tds': rtd,
        'recieving_tds': recTd,
        'total_fantasy_points': total_F_Points,
        ...
        'last_three_weeks_avg': three_week_average - average_F_Points,
    })
